...
// TODO: Improve stream template for PrintElapsed
...
public:
    ...
    */
    ...
    void PrintElapsed() const {
        std::cout << "Elapsed: " << Elapsed<Duration>().count();
    }

    /*
    * Prints the timer's elapsed time in console with a newline.
    * @tparam Duration The unit of time. Default: milliseconds.
    */
    template <typename Duration = milliseconds,
        type_traits::is_duration_e<Duration> = true>
    void PrintElapsedLine() const {
